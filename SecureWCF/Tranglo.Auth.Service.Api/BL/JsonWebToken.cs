...
namespace Tranglo.Auth.Services.Api.BL
{
    public class JsonWebToken
    {
        private string ServerKey = ConfigurationManager.AppSettings["secretKey"].ToString();
        private JwtHashAlgorithm serverJwtHashAlgorithm = JwtHashAlgorithm.HS512;
        private int MinuteExpire = 120;
        private int daysExpire = 30;
        ...
        public string Encode(object payload, byte[] keyBytes, JwtHashAlgorithm algorithm)
        {
            ...
            var header = new { algo = algorithm.ToString(), type = "JWT", expire = secondsSinceEpoch };
